/*
甜蜜派对 五月宠爱季
10 3 20-28 5 * opencard0520.js, tag=5.20~5.28 甜蜜派对 五月宠爱季, enabled=true
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      authorCodeList = [
        '2895e049f29244fc8678838a7d0c8911',
        'dceffab25db84af092caab32f0194f37',
        '2fd3737cf6c744bd96ef5741f2b875d3'
      ];
