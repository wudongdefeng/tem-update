...
[task_local]
#0413开卡
10 1,7 * * * wind_opencard0413.js, tag=0413开卡, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_syj.png, enabled=true

================Loon==============
[Script]
cron "10 1,7 * * *" script-path=wind_opencard0413.js, tag=0413开卡


*/
const $ = new Env('0413开卡');
...
!(async () => {
  ...
  let shareUuidArr = ["8a42154b0bfa429d8a21b05d067e5d3c","ab06a92bd02c4372b0f228862e38b461","df7cfd939beb4d128fb6801dd6dcf8a1"]
