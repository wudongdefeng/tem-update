...
5.抽奖 (默认不抽奖 如需抽奖请设置环境变量[guadraw6]为"3"
填写要抽奖的次数 不足已自身次数为准
guadraw6="3"
填非数字会全都抽奖
...
All变量适用
————————————————
入口：[ 1.14~1.21 超级年货节 惊喜不打烊 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dzlhkkkbblnt20220114&shareUuid=63e54875a00d4e028ee1ab27fbeef159)]
...
guaopencard_draw = $.isNode() ? (process.env.guadraw6 ? process.env.guadraw6 : guaopencard_draw) : ($.getdata('guadraw6') ? $.getdata('guadraw6') : guaopencard_draw);
...
!(async () => {
  ...
  $.shareUuid = "63e54875a00d4e028ee1ab27fbeef159"
...
async function run() {
  try {
    ...
    }else console.log('如需抽奖请设置环境变量[guadraw6]为"3" 3为次数');
