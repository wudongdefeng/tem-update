...
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dzcjlhkk20211212&shareUuid=748d7a963f7447e38e162d38243fc477

默认执行脚本。如果需要不执行
环境变量 NO_RUSH=false
*/
const $ = new Env("12.12 狂欢购");
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/code/raw/master/lzdz1_crazy.json')
    if($.getAuthorCodeListerr === false){
        authorCodeList = [
            '748d7a963f7447e38e162d38243fc477',
        ]
    }
...
async function rush() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            $.log("->->->> 任务")
            await task("dz/openCard/saveTask", `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&actorUuid=${$.actorUuid}&type=1&taskValue=100018819940`)
        }
    }
}
