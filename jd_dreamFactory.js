...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN('https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/jd_updateFactoryTuanId.json')
  if (!res) {
    $.http.get({url: 'https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/jd_updateFactoryTuanId.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await updateTuanIdsCDN('https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/jd_updateFactoryTuanId.json');
  }
