...
#京喜财富岛
18 0-23/1 * * * node /scripts/jd_kingran_wind_cfd.js >> /scripts/logs/jd_kingran_wind_cfd.log 2>&118 0,18 * * * * * * node /scripts/jd_kingran_wind_cfd_help.js >> /scripts/logs/jd_kingran_wind_cfd_help.log 2>&1
12 0,18 * * * node /scripts/jd_kingran_wind_cfd_help.js >> /scripts/logs/jd_kingran_wind_cfd.log 2>&1
