...
#点点卷
10 2,22 * * * node /scripts/jd_wind0_wind_necklace_new.js >> /scripts/logs/jd_wind0_wind_necklace_new.log 2>&1
# 东东超市兑换奖品
...
# 京东排行榜
21 9 * * * node /scripts/jd_wind4_jd_rankingList.js >> /scripts/logs/jd_wind4_jd_rankingList.log 2>&1
# 天天提鹅
...
#京喜财富岛
18 0-23/1 * * * node /scripts/jd_wind0_wind_cfd.js >> /scripts/logs/jd_wind0_wind_cfd.log 2>&1
