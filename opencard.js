...
!(async () => {
  ...
  authorCodeList = await getAuthorCodeList('https://codeberg.org/wudongdefeng/updateTeam/raw/branch/main/shareCodes/opencard91.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            '2ea0671e670e4cdb9e24b8b6822207b0',
        ]
    }
