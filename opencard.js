...
!(async () => {
  ...
  $.MixNicks = ''
  authorCodeList = await getAuthorCodeList('https://codeberg.org/wudongdefeng/updateTeam/raw/branch/main/shareCodes/opencard.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'clgbkabWGOqxDYqcXo0rh2BUh0gimxufjFRMgNwy0cYiU+N6ZQy0LI2KZrs00RAY',
        ]
    }
  $.inviteNick = authorCodeList[Math.floor((Math.random() * authorCodeList.length))]
