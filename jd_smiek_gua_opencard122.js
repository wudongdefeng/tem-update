...
3.加购5京豆
  (默认不加购 如需加购请设置环境变量[guaopencard2]为"true"
4.抽奖 (默认不抽奖 如需抽奖请设置环境变量[guadraw2]为"3"
填写要抽奖的次数 不足已自身次数为准
guadraw2="3"
填非数字会全都抽奖
...
All变量适用
————————————————
入口：[ 3.22~3.31 大牌好礼 迎春季 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dzlhkk068d4d0ab8a1256853002f50&shareUuid=d1f7d90414ec43d79aee78599f491905)]
...
guaopencard_addSku = $.isNode() ? (process.env.guaopencard2 ? process.env.guaopencard2 : `${guaopencard_addSku}`) : ($.getdata('guaopencard2') ? $.getdata('guaopencard2') : `${guaopencard_addSku}`);
...
guaopencard = $.isNode() ? (process.env.guaopencard2 ? process.env.guaopencard2 : `${guaopencard}`) : ($.getdata('guaopencard2') ? $.getdata('guaopencard2') : `${guaopencard}`);
...
guaopencard_draw = $.isNode() ? (process.env.guadraw2 ? process.env.guadraw2 : guaopencard_draw) : ($.getdata('guadraw2') ? $.getdata('guadraw2') : guaopencard_draw);
...
!(async () => {
  if ($.isNode()) {
    if(guaopencard+"" != "true"){
      console.log('如需执行脚本请设置环境变量[guaopencard2]为"true"')
    }
    if(guaopencard+"" != "true"){
      return
    }
  ...
  $.shareUuid = "d1f7d90414ec43d79aee78599f491905"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,"46ee83463e824a24970d5ad9c40c0ca2","9e9173fb2c4d4665aaa738357e6d7a72","3b818352813148abbc29944ded3a2ca8","80315beebbbf4e778d7cb225374e7f77","dd3ebd83e18949669455b2a7858093c4","7b1c532371f54ebb94c9241133f67fa6","cf8fbe40a3a142dea548510c524ed6ce","938ad49317684c86ad86fe6aada50bef"]
  ...
  try {
    ...
    if(!$.addCart && !$.outFlag){
      if(guaopencard_addSku+"" == "true"){
        ...
        console.log('如需加购请设置环境变量[guaopencard2]为"true"');
      }
    }
    if(flag){
      await takePostRequest('activityContent');
    ...
    }else console.log('如需抽奖请设置环境变量[guadraw2]为"3" 3为次数');
