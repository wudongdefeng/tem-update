...
class IiII1Iil {
    ...
    async ["getH5st"](l1llIllI) {
        ...
        try {
            if (!(typeof l1llIllI === "object" && l1llIllI !== null)) return console.log("❌ getH5st 传入参数有误"), lilIil1I; else {
                ...
                if (Iliiiii1.length > 0) {
                    return console.log("❌ getH5st 传入参数有误，缺少必要参数：" + Iliiiii1.join(", ")), lilIil1I;
                }
            }
            ...
            return lilIil1I.h5st = lllllli || "", lilIil1I.params += lllllli || "", lilIil1I;
        } catch (liiI1lII) {
    ...
    ["_SHA256"](lIlIl1lI) {
        ...
        function i11iIiI1(iiiI1IiI, Iii1Iil1) {
            ...
            for (var IlI1Iii1 = 0; IlI1Iii1 < iiiI1IiI.length; IlI1Iii1 += 16) {
                ...
                for (var li1iiIi1 = 0; li1iiIi1 < 64; li1iiIi1++) {
                    if (li1iiIi1 < 16) l1Ii111I[li1iiIi1] = iiiI1IiI[li1iiIi1 + IlI1Iii1]; else l1Ii111I[li1iiIi1] = i1l1Ii1I(i1l1Ii1I(i1l1Ii1I(l1l1IIII(l1Ii111I[li1iiIi1 - 2]), l1Ii111I[li1iiIi1 - 7]), Iil1illl(l1Ii111I[li1iiIi1 - 15])), l1Ii111I[li1iiIi1 - 16]);
        ...
        function IIl11I(IIl1ll1l) {
            ...
            for (var llIIiI1 = 0; llIIiI1 < IIl1ll1l.length; llIIiI1++) {
                ...
                if (IIiliI < 128) lll1iil += String.fromCharCode(IIiliI); else {
                    if (IIiliI > 127 && IIiliI < 2048) {
                        lll1iil += String.fromCharCode(IIiliI >> 6 | 192);
                        lll1iil += String.fromCharCode(IIiliI & 63 | 128);
                    } else lll1iil += String.fromCharCode(IIiliI >> 12 | 224), lll1iil += String.fromCharCode(IIiliI >> 6 & 63 | 128), lll1iil += String.fromCharCode(IIiliI & 63 | 128);
                }
            }
        ...
        return lIlIl1lI = IIl11I(lIlIl1lI), i1IiliI(i11iIiI1(i1Ii1Ili(lIlIl1lI), lIlIl1lI.length * Ii11ili1));
    }
