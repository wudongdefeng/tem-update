...
惠聚京东 好物连连
10.31 - 11.12
https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/5063373?activityId=llk20211031a&shareUuid=3cab686e22644c699033093bf273773e
*/
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/dongge/raw/master/dongge/lzdz1_huanju4.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            '3cab686e22644c699033093bf273773e',
        ]
    }
        ...
        if ($.secretPin) {
            ...
            if ($.openCardList) {
                for (let i = 0; i < ($.openCardList.length); i++) {
                    $.log(">>> 模拟上报访问记录")
                    await task('crm/pageVisit/insertCrmPageVisit', `venderId=1000348121&pageId=llk20211031a&elementId=入会跳转&pin=${encodeURIComponent($.secretPin)}`, 1)
                    await $.wait(2000)
                }
