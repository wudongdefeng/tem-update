...
async function sendNotify(
  ...
  await Promise.all([
   ...
   if (desp.indexOf('已可领取') > -1 || desp.indexOf('此ip已被限制') > -1 || desp.indexOf('IP') > -1 || desp.indexOf('ip') > -1 || desp.indexOf('填写收货地址') > -1 || desp.indexOf('问卷') > -1 || desp.indexOf('可免费领取') > -1 || desp.match(/100.0[0-9]%/))
  {
