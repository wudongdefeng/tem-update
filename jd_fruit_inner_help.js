...
=========================Loon=============================
[Script]
cron "20 4,16 7 7 7" script-path=jd_fruit_help.js,tag=东东农场内部互助
...
async function iIIlll1I() {
    try {
        ...
        IIiIlill ? (console.log("\n" + IIiIlill), newShareCodes.push(IIiIlill), newShareCodes.push('64af0fffd7b3478585b2b71b377613ce'), newShareCodes.push('9fe344f3887243339369fd1f564ec49e'), newShareCodes.push('141be55835d4494fb06b0ac4e895ddef')) : console.log("\n数据异常");
    } catch (l1ii111) {
        $.logErr(l1ii111);
    }
}
