...
3.加购5京豆
  (默认不加购 如需加购请设置环境变量[guaopencard6]为"true"
4.浏览店铺1豆/个
5.浏览商品1豆/个
...
All变量适用
————————————————
入口：[ 4.18~4.24 发现精彩世界，品味趣味人生 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dz690f282607b5c03ea329yjkk2cwl&shareUuid=ea324215c4274a5086f105cf1e0b9349)]
...
guaopencard_addSku = $.isNode() ? (process.env.guaopencard6 ? process.env.guaopencard6 : `${guaopencard_addSku}`) : ($.getdata('guaopencard6') ? $.getdata('guaopencard6') : `${guaopencard_addSku}`)
...
guaopencard = $.isNode() ? (process.env.guaopencard6 ? process.env.guaopencard6 : `${guaopencard}`) : ($.getdata('guaopencard6') ? $.getdata('guaopencard6') : `${guaopencard}`)
...
!(async () => {
    ...
    $.shareUuid = 'ea324215c4274a5086f105cf1e0b9349'
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
    shareUuidArr = [$.shareUuid,'071c3065b92f4f16ba90956a9e157c4d','1ffbe86b64f44885bd39c900a9ca3563','6315335419234dbcaffe451f9b750760','699e69e66c934edc8baf00a888783b58','e68bafe5d28643b087116a9eba906f4c','b5234db1359b43ff952eedb17871816e','4dc5fc91290e4e0ab5daa110ad5d0d40','935446b76b514bc89fee18997c267779','a06340ab004c4e16b56db501f2145ebf']
    ...
    try {
        ...
        if(!$.addSku && !$.outFlag){
            if(guaopencard_addSku+'' == 'true'){
                ...
                console.log('如需加购请设置环境变量[guaopencard6]为"true"')
            }
        }
        $.runFalag = true
        $.log('浏览店铺: ' + $.toShop)
