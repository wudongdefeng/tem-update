...
1.邀请一人10豆
2.开10张卡 成功开1张 获得10豆
3.抽奖 (默认不抽奖 如需抽奖请设置环境变量[guadraw5]为"3"
...
guaopencard_addSku = $.isNode() ? (process.env.guaopencard5 ? process.env.guaopencard5 : `${guaopencard_addSku}`) : ($.getdata('guaopencard5') ? $.getdata('guaopencard5') : `${guaopencard_addSku}`);
...
guaopencard = $.isNode() ? (process.env.guaopencard5 ? process.env.guaopencard5 : `${guaopencard}`) : ($.getdata('guaopencard5') ? $.getdata('guaopencard5') : `${guaopencard}`);
...
guaopencard_draw = $.isNode() ? (process.env.guadraw5 ? process.env.guadraw5 : guaopencard_draw) : ($.getdata('guadraw5') ? $.getdata('guadraw5') : guaopencard_draw);
...
!(async () => {
  ...
  $.shareUuid = "a94b96ac4e5a4686bfd700d11733e857"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,"f4eedc5ebe3b4817979a3a987ae2264e"]
...
async function run() {
  try {
    ...
    }else console.log('如需抽奖请设置环境变量[guadraw5]为"3" 3为次数');
