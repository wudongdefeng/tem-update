...
const inviteCodes = [
  'm7PBgqb7k3q-Alnp8H1HgQ==@UMkDMoEEMOHrLzv9vYo2jA==',
  'm7PBgqb7k3q-Alnp8H1HgQ==@UMkDMoEEMOHrLzv9vYo2jA==',
  'm7PBgqb7k3q-Alnp8H1HgQ==@UMkDMoEEMOHrLzv9vYo2jA==',
  'm7PBgqb7k3q-Alnp8H1HgQ==@UMkDMoEEMOHrLzv9vYo2jA==',
];
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `https://cdn.jsdelivr.net/gh/wudongdefeng/jd-temporary@main/wind_dream.json`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(JSON.stringify(err))
          console.log(`${$.name} API请求失败，请检查网路重试`)
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    //Node.js用户请在jdCookie1.js处填写京东ck;
